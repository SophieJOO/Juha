...
const quickNoteSchema = z.object({
  ...
  kind: z.enum(["INCIDENT", "NEUTRAL", "POSITIVE"]).default("INCIDENT"),
...
const detailSchema = z.object({
  ...
  antecedentText: z.string().trim().optional(),
  earlySignText: z.string().trim().optional(),
  selfRegulationText: z.string().trim().optional(),
...
export async function saveDetailedObservation(
  ...
  try {
    ...
    const observationText = [
      input.cueRawText,
      input.antecedentText,
      input.earlySignText,
      input.selfRegulationText,
    ...
    await saveObservationDetail({
      ...
      antecedentText: optionalText(input.antecedentText),
      earlySignText: optionalText(input.earlySignText),
      selfRegulationText: optionalText(input.selfRegulationText),
